...
def protected_secret(password, secret, num_attempts):
    ...
    def get_secret(password_attempt):
        if num_attempts == 0:
            ...
            # how to pass a new function with num_attempts - 1?
            # just create a new one from factory function.
            # or change function signature: get_secret(password_attempt, num_attempts)
